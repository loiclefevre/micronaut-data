...
For SQL dialects, you can also compute optimistic locking values with ann:io.micronaut.data.annotation.sql.GeneratedEtag[] and ann:io.micronaut.data.annotation.sql.ETagValue[].
